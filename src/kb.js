...
"whitman-journeyWorkOfStars":
`
**Walt Whitman, Song of Myself, part 31**<p>
...
And the running blackberry would adorn the parlours of heaven.<br>


<p>
<dl>
  <dt><b>chef-d'oeuvre: masterpiece</b></dt>
  <dd>French, "principal work"</dd>
...
"bedroom-euclidean-monocular": ` **Reconstruction of the painting
using artificial perspective** <p> From page 115 of Patrick Heelan,
Space Perception and the Philosopy of Science, Hyperbolic Visual
Space, Evicence from the History of Art: <blockquote> The linear
perspective of a painting can be studied by making a ground plan and
elevation of the scene represented.  Thic can be done only if the
dimensions of the motifs depicted in the painting are known.  <p> Such
a plan and elevation is given in figure 6.4; the reconstruction of the
room (the original was destroyed in WWII) is based on certain
assumptions about the size of the room and on measurements of
furniture provided by the Musee d'Arles and other sources.  <p> The
reconstruction given here agrees reasonable weel with that given by
John Ward except for the dimensions of the bed and the inferred
position of the artist.  <p> This drawing is a mathematical projection
can be constructed according to the laws of artiicial perspective,
taking the eye of the painter to be at the center of perspective for
the painting.
...
`
**Santayana: on having a religion**
<p>
Philosoper, essayinst, poet and novelist, 1863-1952.
<p>
In an essay first published in 1966,
appearing as the fourth chapter of the 1973 <u>Interpretation of Culture</u>,
Geertz begins his 1966 essay, Relgion as a Cultural System, with
this epigraph from George Santayana:
...
<p>Thus every living and healthy religion has a
...
"geertz":
`
<b>Clifford James Geertz</b><p>
1926-2006


An American anthropologist who is remembered mostly for his strong
support for and influence on the practice of symbolic anthropology.
He was considered "for three decades... the single most influential
cultural anthropologist in the United States."
<p>
<ul>
   <li> thick description
   <li> local knowledge
   
</ul>

<iframe width="560"height="315"
   src="https://www.youtube.com/embed/3dQDx3axrDs?si=PvGPACyXs4i6p4sL"
   title="YouTube video player" frameborder="0" allow="accelerometer;
   autoplay; clipboard-write; encrypted-media; gyroscope;
   picture-in-picture; web-share"
   referrerpolicy="strict-origin-when-cross-origin"
...
<iframe width="560" height="315"
   src="https://www.youtube.com/embed/d6FftV-XGV0?si=xZLlwMDJJitUJJpd"
   title="YouTube video player"
   frameborder="0"
   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
   referrerpolicy="strict-origin-when-cross-origin"
...
"mudra":
`
<b>Dogen on the Cosmic Mudra</b>

“When one displays the buddha mudra with one’s whole body and mind…”
<p>

This “one” is a translation of hito – it means a person. He didn’t say
“if a buddha sits in zazen” or “if an enlightened person sits in
zazen,” but any person, and even for a short time. Even if we sit as a
very beginner for the first time, the same thing happens in our
zazen. Buddha mudra is a translation of butsu in. Earlier, Dōgen used
the expression ichi butsu shin in; this is the same thing. This in is
mudra, ichi is of course one, so this means, “one buddha mind mudra.”

<p>

You may know the word “mudra.” [shows mudra with hands]. When we sit
in zazen we hold our hands like this and we make an oval with the
thumbs. This is called hokkai gyo in; in English, “cosmic mudra.” This
means that two sides or duality becomes one, one form, or one
circle. In Buddhism, there are many different mudras or ways to hold
the hands depending upon which buddha is being described or
depicted. Each mudra has its own meaning. But here, this kanji for
mudra means in English a stamp or seal. A seal is when you write a
letter, put it in an envelope and seal it with something, or put a
stamp on it to show by whom this letter is written. Stamps or seals
are very important in Chinese and Japanese culture. On certain
paintings or calligraphy, if someone’s seal is there, it is a
certification that this painting or calligraphy was done by this
person. Even today in Japanese society we have a stamp or a seal, and
we use it to make legal interactions. This stamp is like a signature
in American society.
...
`
**The Western Illusion of Human Nature**<p>
...
The term interpellation is more common in French, the language in
which Althusser originally introduced the concept, than English. It
comes from the French verb interpeller, meaning "call out [to
someone]", "speak (abruptly) [to get someone's attention, to request
something, or to insult someone]". This French verb also has several
technical legal senses: to pose questions when interrogating a
suspected criminal; to notify someone that they are legally obliged to
do something; or a parliamentary summons to someone to account for
themself. Thus in both French and English the noun interpellation
denotes the act of interpellating someone.

**Precursors**<p>

The German philosophers Theodor Adorno and Max Horkheimer employed a
method of analysis similar to Althusser's notion of interpellation in
their text Dialectic of Enlightenment, although they did so 26 years
before "Ideology and Ideological State Apparatuses" was
published. Rather than situating their analysis heavily on the State,
Adorno and Horkheimer argued that the mass media—the "culture
industry"—also plays a role in the construction of passive
subjects. So unlike the police officer in Althusser's example who
reinforces the ideology of democracy and law, the mass media now plays
a powerful complementary role in the creation of a passive
consumer. However, whereas Althusser sought to make subjectivity a
mere epiphenomenon of institutional interpellation, Adorno and
Horkheimer insisted on a concept of subjectivity that was not limited
to an institutional definition. They sought to expose tendencies
favoring "total administration" over the individual and their
subjective potential, while Althusser's analysis seemed only to
confirm those tendencies.

**Overview**<p>

In "Ideology and Ideological State Apparatuses (Notes Towards an
Investigation)", Althusser introduces the concepts of ideological
state apparatuses (ISAs) and repressive state apparatuses (RSAs),
institutions which make up society and which are instrumental to the
constant reproduction of the relations of production in that
society. While RSAs are institutions that directly repress dissent and
opposition (for example, the police and the military), ISAs (for
example family, church, schools, the media and politics) reproduce
capitalism through non-repressive ideological means. Consequently,
interpellation describes the process by which ideology, embodied in
major social and political institutions (ISAs and RSAs), constitutes
the very nature of individual subjects' identities.
<p>
Althusser sees interpellation as an act of "hailing" individuals
through social interactions: "all ideology hails or interpellates
concrete individuals as concrete subjects"; "ideology 'acts' or
'functions' in such a way that it ... 'transforms' the individual into
subjects". For Althusser, interpellation ("hailing") is a
non-specific and unconscious process. For example, when a police
officer shouts (or hails) "Hey, you there!" and an individual turns
around and, so-to-speak, 'answers' the call, the individual becomes a
subject. Althusser argues that this is because the individual has
realized that the hailing was addressed at him which makes him
subjective to the ideology of democracy and law.
Another example is of a friend who knocks on a door. The person inside
asks "Who is there?" and only opens the door once the "It's me" from
the outside sounds familiar. By doing so, the person inside partakes
in "a material ritual practice of ideological recognition in everyday
life". In other words, Althusser's central thesis is that "you and
I are always already subjects" and are constantly engaging in everyday
rituals, like greeting someone or shaking hands, which makes us
subject to ideology.
<p>
Althusser argued that "there is no ideology except by the subject and
for the subject". This notion of subjectivity became central to his
thought. According to Althusser, "ideology has always-already
interpellated individuals", that is, individuals are constituted as
subjects through being interpellated from before they are even
born. He further remarks about the individual identity under these
conditions:

<blockquote>the individual is interpellated as a (free) subject in order that he
shall submit freely to the commandments of the Subject, i.e. in order
that he shall (freely) accept his subjection, i.e. in order that he
shall make the gestures and actions of his subjection 'all by
himself'.
</blockquote>

Consequently, individual subjects are presented principally as
produced by social forces, rather than acting as powerful independent
agents with self-produced identities. Althusser's argument here
strongly draws from Jacques Lacan's concept of the mirror
stage. However, unlike Lacan who distinguishes between the "I" (i.e.,
the conscious ego which is created by the mirror stage) and the
"subject" (that is, the symbolic subject of the unconscious),
Althusser collapses both concepts into one.

**Other applications**<p>

Althusser's thought has made significant contributions to other French
philosophers, notably Derrida, Kristeva, Barthes, Foucault, Deleuze,
and Badiou. The feminist scholar and queer theorist Judith Butler
critically applied a framework based on interpellation to highlight
the social construction of gender identities. Butler argues that by
hailing "It's a boy/girl," the newborn baby is ultimately positioned
as subject.
<p>

Media theorist David Gauntlett argues that "interpellation occurs when
a person connects with a media text: when we enjoy a magazine or TV
show, for example, this uncritical consumption means that the text has
interpellated us into a certain set of assumptions, and caused us to
tacitly accept a particular approach to the world."


`,
"althusser":
`
**Louis Pierre Althusser**<p>

1918 – 1990,  a French
Marxist philosopher who studied at the École normale supérieure in
...
French Communist Party (Parti communiste français, PCF). His arguments
and theses were set against the threats that he saw attacking the
theoretical foundations of Marxism. These included both the influence
of empiricism on Marxist theory, and humanist and reformist socialist
...
ideology. Althusser is commonly referred to as a structural Marxist,
although his relationship to other schools of French structuralism is
not a simple affiliation and he was critical of many aspects of
structuralism. He later described himself as a social anarchist.
...
and committed to a psychiatric hospital for three years. He did little
further academic work, dying in 1990.
...
_Ideology and Ideological State Apparatuses (Notes Towards an
Investigation)_ is an essay by the French Marxist
philosopher Louis Althusser. First published in 1970, it advances
Althusser's conception and critique of ideology.

<p>
Where Karl Marx and
Friedrich Engels posited a thinly-sketched theory of ideology as a
system of falsehoods serving the ruling class,
Althusser draws upon the works of later theorists such as Antonio
Gramsci, Sigmund Freud and Jacques Lacan to proffer a more elaborate
redefinition of the theory. Althusser's theory of ideology has
remained influential since it was written.
`,
...
"geertz-weber":
`
<b>Believing, with Max Weber ...</b>
<p>
In Chapter 1 of his 1973 essay collection, The Interpretation of Cultures,
Geertz states his aim:
<blockquote>
The concept of culture I espouse, and whose utility the
essays below attempt to demonstrate, is essentially a
semiotic one.
<p>
...
culture as that ethos is manifested in actual behavior.
</blockquote>
`,
